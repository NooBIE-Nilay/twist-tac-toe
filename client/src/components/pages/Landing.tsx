...
export function Landing() {
    return (
        <>
            <GameHeading />
            <div className="flex flex-col items-center justify-center md:mt-20 md:flex-row md:gap-12">
                <div className="order-2 md:order-none">
                    <ShineBorder
                        className="aspect-square w-[250px] items-center justify-center rounded-lg border bg-background shadow-xl md:w-[350px]"
                ...
                <div className="order-1 flex h-[400px] w-[500px] flex-col items-center justify-center gap-6 md:order-none">
                    ...
                    <div className="z-10 order-2 flex items-center justify-center">
                        <Link to="/join">
                            <AnimatedGradientText className="text-xl">
                                🤝🏻{" "}
                                <hr className="mx-2 h-8 w-[1px] shrink-0 bg-gray-300" />{" "}
