...
export function Landing() {
  return (
    <>
      <GameHeading />
      <div className="flex flex-col  md:flex-row justify-center items-center  md:gap-12  md:mt-20  ">
        <div className="order-2 md:order-none">
          <ShineBorder
            className="w-[250px]  md:w-[350px] justify-center items-center  rounded-lg border bg-background shadow-xl aspect-square"
            color={["#A07CFE", "#FE8FB5", "#FFBE7B"]}
          >
            <svg
              className=" aspect-square  p-6 md:p-3 "
        ...
        <div className="flex h-[400px] flex-col  justify-center items-center w-[500px] gap-6 order-1 md:order-none ">
